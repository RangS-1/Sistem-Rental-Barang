...
// Mengambil halaman aktif dari URL, default ke 'home'
...
<div class="container">
    ...
    <?php if ($page == 'home'): ?>
        <!-- HALAMAN HOME: MENAMPILKAN BARANG TERSEDIA (HIJAU) -->
        <div class="page-content animate-fade">
            ...
            <div class="grid">
                <?php
                // Query mengambil 3 barang dengan status 1 (Tersedia)
    ...
    <?php elseif ($page == 'katalog'): ?>
        <!-- HALAMAN BARANG YANG DISEWA: MENAMPILKAN BARANG DIPINJAM (OREN) -->
        <div class="page-content animate-fade">
            <div class="header-section">
            ...
            <div class="grid">
                <?php
                // Query mengambil 3 barang dengan status 0 (Dipinjam)
