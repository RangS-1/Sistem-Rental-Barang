 ...
 * Nama database disesuaikan menjadi 'rentalin' sesuai data di phpMyAdmin.
 */
$koneksi = mysqli_connect("localhost", "root", "", "rentalin");
...
/**
 * 2. PROTEKSI AKSES (SOLUSI USER NYASAR)
 * Mengecek apakah session role ada dan apakah nilainya 'admin'.
 * Jika tidak, user akan dipaksa keluar ke halaman utama (index.php).
 */
...
/**
 * 3. HANDLING LOGIKA (CRUD & STATUS)
 * Mengacu pada file Control.php di folder class.
 */
...
/**
 * 4. PENGAMBILAN DATA INVENTARIS
 */
$queryBarang = mysqli_query($koneksi, "SELECT * FROM barang_sewa ORDER BY id DESC");
